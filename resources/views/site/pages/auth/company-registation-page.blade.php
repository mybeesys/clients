    ...
    <div class="container">
        <div class="card bg-light" style="max-width: 800px;  margin-right: auto; margin-left: auto;">
            <article class="card-body ">
                <h2 class="text-center" style="color:#6666cc;">Sign up</h2>
                <form method="POST" action="{{ route('site.company.register') }}">
                    @csrf
                    <fieldset>

                        <div class="mt-4 row-fluid">
                            <div class="control-group">
                                <label for="" class=" control-label  mb-1 " data-original-title=""> Name
                                </label>
