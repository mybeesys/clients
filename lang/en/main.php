...
return [
    ...
    'wizard' => [
        ...
        'subscription_choose_title' => 'Choose the right plan',
        'subscription_period' => 'Subscription schedule',
        'subscription_period_hint' => 'Set the start and end dates for this subscription (optional).',
        'subscription_plan_optional_hint' => 'You can assign a plan later from the admin panel.',
        'subscription_skip_badge' => 'No plan',
        'subscription_skip_title' => 'Continue without a plan',
        'subscription_selected_label' => 'Selected plan',
        'subscription_features_included' => 'features included',
        'no_plans_for_period' => 'No plans for this billing period — try switching between monthly and annual.',
